      ...
      <div className="page-shell max-w-2xl w-full text-center relative">
        <div className="page-hero border-accent/12">
          <div className="page-hero-inner">
            <span className="toolbar-chip w-fit mx-auto border-accent/20 bg-accent/[0.08] text-accent">
              Maximo SEO
            </span>
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 mt-8">
          {[
            ...
            {
              icon: (
                <svg className="h-6 w-6 text-accent-hover" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div
              key={feature.title}
              className="rounded-xl border border-accent/10 bg-surface/60 p-5 text-left backdrop-blur-sm transition-all duration-300 hover:border-accent/25 hover:shadow-elevation-1"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-accent/15 bg-accent/[0.08] mb-3">
                {feature.icon}
              </div>
        ...
        <div className="flex flex-col items-center gap-3 mt-10">
          ...
          <Link
            href="/auth/register"
            className="text-sm text-text-secondary hover:text-accent-hover transition-colors"
          >
            Create Account
          </Link>
        </div>
